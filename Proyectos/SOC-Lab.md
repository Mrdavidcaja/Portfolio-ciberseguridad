...
## 1. Objetivo
Simular el funcionamiento de un SOC (Security Operations Center) para demostrar conocimientos básicos de detección, análisis y respuesta a incidentes.
...
1. **Confirmar si es actividad maliciosa**
   ...
   - Verificar si hay correlación con otros eventos
...
3. **Contención**
   ...
   - Aislar el equipo afectado en la red
